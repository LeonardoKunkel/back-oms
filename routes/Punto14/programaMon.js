...
// MonitoreoMedicion1 = require('../models/Elemento14/programaMonitoreoMedicionParametrosDesemp'),
...
router.post('/create',[verificarToken], (req,res) => {
    ...
    MonitoreoMedicion1.create(MonitoreoMedicion2,(err,MonitoreoMedicion2Bd) => {
        if (err) {
            res.status(400).json({
...
router.get('/', [verificarToken], (req,res) => {
    MonitoreoMedicion1.find().
    exec((err,MonitoreoMedicion3) => {
        if (err) {
            res.status(400).json({
