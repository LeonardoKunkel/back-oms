const express = require('express'),
      PermisoTrabajoPeligroso = require('../models/Elemento10/FO-09 Permiso de trabajo peligroso'),
...
router.post('/create',[verificarToken], (req,res) => {
    ...
    let permisoTrabajo = {
        ...
        fecha1:body.fecha1,
        fecha2:body.fecha2,
        escribeequipo:body.escribeequipo,
        escribetrabajo:body.escribetrabajo,
        escrbemedidas:body.escrbemedidas,
        check1:body.check1,
        check2:body.check2,
        check3:body.check3,
        check4:body.check4,
    ...
    PermisoTrabajoPeligroso.create(permisoTrabajo,(err, permisoTrabajoPeligrosoBd) => {
        if (err) {
            res.status(400).json({
...
router.get('/', [verificarToken], (req,res) => {
    PermisoTrabajoPeligroso.find().
        exec((err,permisoTrabajo) => {
            if (err) {
                res.status(400).json({
