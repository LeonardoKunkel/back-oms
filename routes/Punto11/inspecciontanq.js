...
InspeccionTanques1 = require('../models/Elemento11/FO-01'),
...
router.post('/create',[verificarToken], (req,res) => {
    ...
    InspeccionTanques1.create(InspeccionTanques2,(err,InspeccionTanques2Bd) => {
        if (err) {
            res.status(400).json({
...
router.get('/', [verificarToken], (req,res) => {
    InspeccionTanques1.find().
    exec((err,InspeccionTanques3) => {
        if (err) {
            res.status(400).json({
