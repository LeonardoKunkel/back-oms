const express = require('express'),
      ProgramaMonitoreoMedicion = require('../models/Elemento14/FS-29 Programa de monitoreo y medición de parámetros de desempeño'),
...
router.post('/create',[verificarToken], (req,res) => {
    ...
    ProgramaMonitoreoMedicion.create(monitoreoMedicion,(err, monitoreoMedicionBd) => {
        if (err) {
            res.status(400).json({
...
router.get('/', [verificarToken], (req,res) => {
    ProgramaMonitoreoMedicion.find().
        exec((err,monitoreoMedicion) => {
            if (err) {
                res.status(400).json({
